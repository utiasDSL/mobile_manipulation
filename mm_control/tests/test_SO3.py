...
from mm_utils.math import casadi_SO2, casadi_SO3_log, casadi_SO3_Rx
...
if __name__ == "__main__":
    ...
    print(
        "x:{}, r:{}, e:{}, dJdx:{}".format(
            xnum, rnum, e_fcn(xnum, rnum), dJdx_fcn(xnum, rnum)
        )
    )
    print(
        "x:{}, r:{}, e_2:{}, dJdx_2:{}".format(
            xnum, rnum, e_fcn_2(xnum, rnum), dJdx_fcn_2(xnum, rnum)
        )
    )
    print(
        "x:{}, r:{}, e_3:{}, dJdx_3:{}".format(
            xnum, rnum, e_fcn_3(xnum, rnum), dJdx_fcn_3(xnum, rnum)
        )
    )
    print(
        "x:{}, r:{}, e_4:{}, dJdx_4:{}".format(
            xnum, rnum, e_fcn_4(xnum, rnum), dJdx_fcn_4(xnum, rnum)
        )
    )
